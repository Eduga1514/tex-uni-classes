...
\usepackage{amssymb, mathtools, amsthm, amsmath, physics} % Varios paquetes de símbolos
...
\fancyfoot[R]{Profesora: Miyana Villasana}
...
\title{
Notas de Introducción a las Redes Neuronales Artificiales, Universidad Simón Bolívar
}
